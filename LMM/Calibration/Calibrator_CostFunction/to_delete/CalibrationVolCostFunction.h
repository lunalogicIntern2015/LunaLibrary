...
//
//
//class CalibrationVolCostFunction: public QuantLib::CostFunction
//{
//public:
//
...
//	QuantLib::Disposable<QuantLib::Array>  penalty( size_t sparse_step, size_t present_column_index) const ;
//

...
double GenericVanillaSwapPricer::genericVanillaSwap_Analytical(GenericSwap_CONSTPTR genericVanillaSwap, const std::vector<double>& liborsInitValue)const 
{
	std::vector<Coupon_CONSTPTR> floatingLeg	=	genericVanillaSwap->getLeg1()->getLeg();
	std::vector<Coupon_CONSTPTR> fixedLeg		=	genericVanillaSwap->getLeg2()->getLeg();
	...
	Rate1_CONSTPTR firstFloatingRate = firstFloatingCappedFlooredCoupon->getRate();   
	...
	Rate1_CONSTPTR firstFixedRate = firstFixedCappedFlooredCoupon->getRate();   

...
class Scheme_MCS : public Scheme_ADI
{
public:
...
public:
	...
	Scheme_MCS(const Discretization& discret,
...
typedef boost::shared_ptr<Scheme_MCS> Scheme_MCS_PTR;
typedef boost::shared_ptr<const Scheme_MCS> Scheme_MCS_CONSTPTR;
...
//
//const double CONFIG_S_max = fabs(fwd_PDE_SABR_S0)*5;//Option_params_K*8.0;
//const double CONFIG_v_max = fabs(fwd_PDE_SABR_v0)*5;//5.0;
//
//const int    CONFIG_multiplicator = 1;
//const int    CONFIG_sizeDiscretization_t = 50*CONFIG_multiplicator;
//const int    CONFIG_sizeDiscretization_x = 50*CONFIG_multiplicator; //Attention: when compare the precision of uniform and non-uniform result, we need a grid at S = 100 !
...
//
//
//Interpolator_D2 test_SABR_PDE_solution(int CONFIG_sizeDiscretization_y)
//{	
...
//	double alpha = SABR_params_alpha;
//	double beta  = SABR_params_beta;
//	double rho   = SABR_params_rho;
//
...
//	
//
//	cout << " parameter : alpha = " << alpha <<"  beta = " << beta << "   rho = " << rho << endl;
//	cout << " parameter : K = " << K <<"  T = " << T << "   S_min = " << S_min << "    v_min = " << v_min << endl;
//
...
//
//	//! SABR Model
//	SABRModel model  (alpha,beta,rho);
//	//SABR_Model_discret sabr_model_discret(model);
//	//! SABR discret Model 
//	SABR_Model_discret sabr_model_discret(model,discret);
//
//
...
//	//! Forward PDE
//	BoundaryCondition_D2_density bc(cts, payoff, model, discret ,fwd_PDE_SABR_S0, fwd_PDE_SABR_v0);
//
//	//! --------------------------------------------------
//	//! 
//    //!           Test PDE solver 
...
//	//	if(fabs(x-fwd_PDE_SABR_S0)<0.000000001)
//	//	{
//	//		dirac_x_index = i;  
//	//		break;
//	//	}
...
// //       if(fabs(y-fwd_PDE_SABR_v0)<0.000000001)
//	//	{
//	//		dirac_y_index = j;
//	//		break;
//	//	}
...
//
//	//double inital_proba = 1; // already integrated in the boundary condition class ! 
...
//void test_SABR_PDE()
//{	
//	Interpolator_D2 interp_1 = test_SABR_PDE_solution(CONFIG_sizeDiscretization_y);
